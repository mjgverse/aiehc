...
(function () {
  ...
  style.textContent = [
    '#ehc-chat-bubble{position:fixed;bottom:24px;right:24px;width:58px;height:58px;border-radius:50%;background:#14294d;display:flex;align-items:center;justify-content:center;cursor:pointer;box-shadow:0 6px 20px rgba(20,41,77,0.35);z-index:999999;transition:transform 0.15s ease}',
    ...
    '#ehc-chat-header{background:#14294d;color:#fff;padding:16px 18px;font-weight:600;font-size:15px;display:flex;justify-content:space-between;align-items:center}',
    '#ehc-chat-header span.sub{display:inline-block;font-weight:500;font-size:10.5px;color:#cfe0ff;margin-top:4px;letter-spacing:0.3px;background:rgba(255,255,255,0.12);padding:2px 8px;border-radius:20px}',
    ...
    '#ehc-chat-send{background:#14294d;color:#fff;border:none;border-radius:20px;padding:0 16px;font-weight:600;font-size:13px;cursor:pointer;margin-left:8px}',
