...
module.exports = async (req, res) => {
  // --- CORS ---
  // Set ALLOWED_ORIGIN in your Vercel project's env vars to your website's
  // domain (e.g. "https://www.yourcompany.com") once you know it.
  // Leaving it unset falls back to "*" (any site can call this endpoint).
  ...
  try {
    ...
    // Pull knowledge base content from Supabase
...
${kbContext}`;
    ...
    // Log the exchange (non-fatal if it fails)
    supabase
      .from('agent_logs')
